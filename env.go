...
DD_SOCIAL_AUTH_GOOGLE_OAUTH2_ENABLED={{.DD_SOCIAL_AUTH_GOOGLE_OAUTH2_ENABLED}}
...
type envVals struct {
	...
	DD_SOCIAL_AUTH_GOOGLE_OAUTH2_ENABLED  bool
...
func genAndWriteEnv(i *config.DojoConfig, dbURL string) {
	...
	env := envVals{
		...
		DD_SOCIAL_AUTH_GOOGLE_OAUTH2_ENABLED:  			 i.Settings.SocialAuthGoogleOauth2Enabled,
